...
const speakerContent = {
  en: {
    ...
    fields: {
      ...
      bio: "Short Bio",
      whySpeak: "Why do you want to speak at DNS 2027?",
  ...
  es: {
    ...
    fields: {
      ...
      bio: "Bio Corta",
      whySpeak: "¿Por qué quieres hablar en DNS 2027?",
...
const content = {
  en: {
    ...
    fields: {
      ...
      goals: "What are your primary goals for sponsoring DNS 2027?",
  ...
  es: {
    ...
    fields: {
      ...
      goals: "¿Cuáles son tus objetivos principales al patrocinar DNS 2027?",
