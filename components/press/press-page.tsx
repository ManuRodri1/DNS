...
const content = {
  en: {
    ...
    coverageIntro: "Browse published articles and editorial coverage connected to DNS 2027.",
  ...
  es: {
    ...
    coverageIntro: "Explora articulos publicados y cobertura editorial conectada a DNS 2027.",
