  ...
  en: {
    ...
    tickets: [
      ...
      },
      {
        ...
        price: "$399",
        description: "Premium access for leaders and investors seeking high-level networking.",
        benefits: [
          "All General Admission Benefits",
          "VIP Dinner on the Malecón",
          "Exclusive VIP Breakfast Roundtable",
          "Priority Reserved Seating",
          "Priority VIP Fast-Track Entry",
          "Post-Event Networking Database Access",
        ],
        ctaText: "Get VIP Pass",
        ctaLink: "https://buy.stripe.com/9B67sL3bH9QLc6af6G8EM04",
        highlight: true,
        highlightLabel: "Most Recommended",
      },
    ],
  },
  es: {
    ...
    tickets: [
      ...
      },
      {
        ...
        benefits: [
          ...
          "Acceso rápido prioritario (VIP Check-in)",
          "Acceso a la base de datos de networking post-evento",
        ],
        ctaText: "Comprar Pase VIP",
        ctaLink: "https://buy.stripe.com/9B67sL3bH9QLc6af6G8EM04",
        highlight: true,
        highlightLabel: "Lo más recomendado",
      },
    ],
  },
}
...
export function Tickets() {
  ...
  return (
    <section id="tickets" data-header-theme="white" className="relative w-full overflow-hidden bg-white py-16 md:py-24">
      {/* Section Header */}
