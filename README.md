...
> [!NOTE]
> **Backend Temporal**: Este proyecto está utilizando actualmente el proyecto Supabase `cliente-nuevo-facturacion` como backend temporal para las secciones de **Partners**, **Influencers** y **Speakers**.
> 
